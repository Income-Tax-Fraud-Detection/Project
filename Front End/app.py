...
label_encoder_occupation = joblib.load("/Users/vishalhanchate/Desktop/Income Tax Fraud Detection/Project/Models/label_encoder_occupation.joblib")
label_encoder_marital = joblib.load("/Users/vishalhanchate/Desktop/Income Tax Fraud Detection/Project/Models/label_encoder_marital_status.joblib")
label_encoder_children = joblib.load("/Users/vishalhanchate/Desktop/Income Tax Fraud Detection/Project/Models/label_encoder_children.joblib")

def load_best_model():
    return joblib.load("/Users/vishalhanchate/Desktop/Income Tax Fraud Detection/Project/Models/best_model.joblib")
...
def main():
    ...
    # Additional inputs
    if children == "Yes":
        educational_expenses = st.number_input("Educational Expenses")
    else:
        educational_expenses = 0

    if occupation == "Business":
        business_income = st.number_input("Business Income")
    else:
        business_income = 0
